...
function uploadFile() {
    const sBookName = $("#NoteNameId").val();
    const sBookISBN = $("#noteRelatedToSubjectId").val();
    const iSemester = $("#semesterId").val();
    const sBookDescription = $("#noteDescriptionId").val();
    const fileInput = $('#noteFileId')[0];
