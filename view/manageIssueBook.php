    ...
    <section class="section ">
        ...
        <div class="dashboard dashboard_container">
            ...
            <aside>
                <ul>
                    <li>
                        <a href="manageIssueBook.php?iActive=3" class="shadow-lg p-3 mb-5 rounded active"><i class="fa-regular fa-id-card"></i>
                    ...
                    <li>
                        <a href="manageAvailableBook.php" class="shadow-lg p-3 mb-5 rounded"><i class="fa-solid fa-book-open-reader"></i>
                            <h5>Manage Available Book</h5>
                        </a>
                    </li>
                    <li>
                        <a href="manageStaff.php" class="shadow-lg p-3 mb-5 rounded"><i class="fa-solid fa-user-tie"></i>
                            <h5>Manage Staff</h5>
                        </a>
                    </li>
                    <li>
                        <a href="manageLog.php" class="shadow-lg p-3 mb-5 rounded"><i class="fa-solid fa-tarp"></i>
                            <h5>Manage Log</h5>
                        </a>
                    </li>
                </ul>
